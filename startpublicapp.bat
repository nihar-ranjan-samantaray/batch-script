...
IF NOT EXIST C:\EidolaInstall\eidolaPublicApp tar -xzvf eidolaPublicApp-1.0.0.tgz -C C:\EidolaInstall
cd C:\EidolaInstall
C:
...
IF NOT EXIST migrations (echo No migration folder hence creating database & python manage.py db init & echo init done.. & python manage.py db migrate  & echo migrate done.. & python manage.py db upgrade  & echo upgrade done..)
